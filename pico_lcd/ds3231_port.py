...
def DetectDs3231(i2c):
    return DS3231_I2C_ADDR in i2c.scan()

class DS3231:
    def __init__(self, i2c):
        self.ds3231 = i2c
        self.timebuf = bytearray(7)
        #devs = self.ds3231.scan()
        #print("found "+str(len(devs))+" devs")
        #for device in devs:
...
if __name__=='__main__':
    ...
    print(rtc.datetime())
    #i2c = I2C(0, sda=Pin(0, pull=Pin.PULL_UP), scl=Pin(1, pull=Pin.PULL_UP), freq=400000)   
    i2c = I2C(0, sda=Pin(0), scl=Pin(1), freq=400000)   
    #sleep(0.1)
    ds3231 = DS3231(i2c)
    sleep(0.2)
    nt = ds3231.get_time()
    print('DS3231 time:', nt)
    #ds3231.rtc_test(10)
